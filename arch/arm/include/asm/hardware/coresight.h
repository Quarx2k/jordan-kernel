...
#define ETMR_VIEWDATAEVENT	0x30
#define ETMVE_FCN_SHIFT		14
#define ETMVE_FCN_MASK		(0x07 << ETMVE_FCN_SHIFT)
#define ETMVE_RESB_SHIFT	7
#define ETMVE_RESB_MASK		(0x7F << EMTVE_RESB_SHIFT)
#define ETMVE_RESA_MASK		0x7F
