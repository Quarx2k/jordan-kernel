...
unsigned int wakeup_timer_seconds;
 ...
 */
static long wakeup_timer_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	int ret = 0;
...
static DEVICE_ATTR(wake_timer_list, S_IRUGO,
