...
//dma_cache_maint -> ___dma_single_cpu_to_dev
...
void ipc_dma_node2buf_callback(int lch, u16 ch_status, void *data)
{
	...
	if ((ipc_memcpy_node2buf.node_ptr[ipc_memcpy_node2buf.node_index].
		...
		___dma_single_cpu_to_dev((void *) ipc_ch->write_ptr.temp_buff,
		...
		___dma_single_cpu_to_dev((const void *) ipc_ch->write_ptr.temp_buff,
	...
	___dma_single_cpu_to_dev(ipc_memcpy_node2buf.
...
void ipc_dma_buf2node_callback(int lch, u16 ch_status, void *data)
{
	...
	___dma_single_cpu_to_dev(ipc_ch->read_ptr.
