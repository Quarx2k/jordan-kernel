/* This file is automatically generated.  Do not edit. */
   ...
   S_(SECCLASS_BINDER, BINDER__IMPERSONATE, "impersonate")
   S_(SECCLASS_BINDER, BINDER__CALL, "call")
   S_(SECCLASS_BINDER, BINDER__SET_CONTEXT_MGR, "set_context_mgr")
   S_(SECCLASS_BINDER, BINDER__TRANSFER, "transfer")
